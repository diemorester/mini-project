...
export default function PrevEvents() {
    return (
        <div className="bg-sept-purple h-auto">
            <h1 className="h-[250px] text-sept-white text-2xl sm:text-6xl z-30 px-8 place-content-center">[&nbsp;OUR PREVIOUS EVENTS. &nbsp;]</h1>
            <div className="flex flex-wrap gap-6 mx-3 relative pb-[100px]">
                <div className="relative z-20">
                    ...
                    <div>
                        <Image src="/images/festival2.jpg" alt="gigs1" width={425} height={600} />
                    </div>
                    <svg className='fill-sept-white absolute z-50 -top-[9%] -right-[14%] animate-spin-slow-reversed' xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 2048 2048">
                ...
                <div className="relative z-10">
                    <div className="absolute inset-0 z-10 bg-sept-gray text-center items-center justify-center opacity-100 hover:opacity-0 bg-opacity-65 duration-200 transition-all ease-out cursor-pointer">
                        <h2 className="text-sept-white text-3xl sm:text-5xl pt-9">SYNCHRONIZE.</h2>
                    </div>
                    <div>
                        <Image src="/images/festival4.jpg" alt="gigs2" width={425} height={600} />
                    </div>
                </div>
                <div className="relative z-10">
                    <div className="absolute inset-0 z-10 bg-sept-gray text-center items-center justify-center opacity-100 hover:opacity-0 bg-opacity-65 duration-200 transition-all ease-out cursor-pointer">
                        <h2 className="text-sept-white text-3xl sm:text-5xl pt-9">HAMMERSONIC.</h2>
                    </div>
                    <div>
                        <Image className='object-contain' src="/images/festival6.jpg" alt="gigs3" width={425} height={600} />
                    </div>
                </div>
                <svg className='w-[660px] fill-sept-green right-0 -top-36 animate-spin-slow max-md:hidden z-0 absolute' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2048 1280">
