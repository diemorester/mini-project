            ...
            <div className="max-w-[1400px] mx-auto">
                <div className="bg-sept-black">
                    ...
                    <div className="flex relative items-center gap-2">
                        ...
                        <p className="text-2xl right-[3%] -bottom-1 sm:text-4xl italic font-bold text-sept-green absolute sm:-bottom-4 sm:right-[24%] z-10">JAVA JAZZ.</p>
                    </div>
                    <div className='sm:px-36 flex flex-wrap justify-center md:w-[1180px]'>
                        <div className='md:w-1/3 flex'>
                            <Image src="/images/foto4.jpeg" alt='foto1' width={500} height={800} className='' />
                        </div>
                        <div className='relative flex items-center place-content-center md:w-2/3 bg-sept-gray'>
