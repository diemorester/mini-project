...
export default function WhyUs() {
    ...
    return (
        <div id="why">
            <div 
                className="w-full h-[150px] sm:h-[250px] bg-sept-black text-sept-white px-8 place-content-center text-4xl sm:text-7xl">
                <h1 className="">[&nbsp;&nbsp;WHY &nbsp; US.&emsp; &emsp; &nbsp;]</h1>
            </div>
            <div className="text-3xl sm:text-7xl text-sept-white bg-sept-black p-5 relative font-semibold">
                <p 
                ...
                <p className="text-center sm:pl-20">INTO A&nbsp;
