    ...
    return (
        <div className="relative overflow-hidden">
            <div className="w-screen h-[500px] bg-sept-black">
                <Image className="w-screen h-full object-cover opacity-50" src="/images/test.jpg" alt="test" width={2000} height={1000} />
            </div>
            <div className="bg-sept-black relative h-[80px]">
                <div className="flex gap-8 italic absolute -top-[35%] left-[30%]">
                    <div className="text-end">
                        <p className="sm:text-2xl font-bold text-sept-purple">Sunday, </p>
                        <p className="sm:text-2xl font-bold text-sept-white">May 30th</p>
                    </div>
                    <div className="w-[6px] h-16 bg-white "></div>
                    <p className="sm:text-6xl text-sept-green font-extrabold">JAVA JAZZ.</p>
                </div>
            </div>
